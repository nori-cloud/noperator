...
*/}}
{{- define "noperator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "noperator.resourceName" -}}
{{- $fullname := include "noperator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "noperator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "noperator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
